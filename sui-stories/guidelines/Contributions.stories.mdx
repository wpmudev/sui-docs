...
<Meta title="Guidelines/Contributions" />

# Contributions

The **WPMU DEV Products Team** bases the roadmap on its planned design and development path, subject to changes based on our products' needs and our clients' feedback. You can find the entire backlog of this library on our [JIRA](https://incsub.atlassian.net/browse/SUI) board.

## Working on Issues

Before submitting any pull request, please open a task first in the **Backlog** list of our [JIRA](https://incsub.atlassian.net/browse/SUI) board.
...
The final PR commit message for a package should look like this:
...
# For accessibility (only) changes.
...
1. Move the task on the [JIRA](https://incsub.atlassian.net/browse/SUI) board to the "Waiting for Merge" column.
