...
<Meta title="Guidelines/Release" />

# Release

Have in mind this guide is for developers member of the [WPMU DEV Organization](https://www.npmjs.com/package/@wpmudev/shared-ui/) on NPM Registry.
...
The author of all the packages is [WPMU DEV](https://premium.wpmudev.org/) while all the persons involved in the creation or improvement of the package must be added as contributors.
